            ...
            <div class="card-box pd-20 height-100-p mb-30 align-items-center" style="width: 100%;">
				<div class="row" style="display: flex; align-items: center; justify-content: center; width: 100%;">
                    <div class="col-sm-12 col-lg-4">
						<img src="../assets/arnis2.png" alt="" />
					</div>
					<div class="col-sm-12 col-lg-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							<div class="weight-600 font-30" style="color: #024e02;">What is Arnis?</div>
						</h4>
						<p class="font-18">
                            Many people believe that <span>Filipinos are resourceful</span> and proud of it, yet most of the time, 
                            this resourcefulness is about overcoming difficult circumstances.
                        </p>
                        <p class="font-18">
                            An old <span>Filipino martial technique</span> called <span>Arnis</span> is a good example of this. Sticks and bladed 
                            weapons are used in the ancient fighting sport of arnis, which first appeared in the 1500s <span>
                            before the Spanish conquest</span> . The most well-known method included in it is double sticks <span>(doble baston)</span>, 
                            but there are many others. The terms single-stick <span>(solo baston)</span>, stick and knife <span>(espada y daga)</span>, 
                            and knife techniques <span>(daga)</span> are also used.
                        </p>
                        <p class="font-18">
                            In various parts of the Philippines, Arnis is known by many names, including <span class="italic">kali</span>, 
                            <span class="italic">escrima</span>, and <span class="italic">baston</span>. Arnis, for instance, is 
                            referred to as kaliradam in the Bisaya and Illongo languages while kalirongan in the Pangasinan.
                        </p>				
					</div>
				</div>
			</div>
