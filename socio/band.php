        ...
        <section class="sports">
            ...
            <div class="card-box pd-20 height-100-p mb-30 align-items-center" style="width: 100%;">
				<div class="row" style="display: flex; align-items: center; justify-content: center; width: 100%;">
                    <div class="col-sm-12 col-lg-4" style="padding-left: 30px;">
						<img src="../assets/music-band.png" alt="" />
					</div>
					<div class="col-sm-12 col-lg-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							<div class="weight-600 font-30" style="color: #2c772c;">The History of Band</div>
						</h4>
						<p class="font-16">
                            The word "<span>band</span>" is derived from the French word "<span>bande</span>," which means "<span>troop</span>." 
                            An orchestra and a band <span>differ</span> greatly in the <span>instruments</span> they play. Bands have 
                            <span class="italic">brass</span>, <span class="italic">woodwinds</span>, and <span class="italic">percussion</span> instruments, 
                            while orchestras mainly have <span>string</span> instruments.
                        </p>
                        <p class="font-16">
                            "<span>Band</span>" can mean a <span>group of people</span> who perform together, like <span>dance bands</span>. It can also refer to a 
                            <span>specific</span> instrument played by a group, as in <span>brass bands</span>.
                        </p>
                        <p class="font-16">
                            Bands started in <span>Germany</span> in the <span>15th century</span>, originally with <span class="italic">bassoons</span> and 
                            <span class="italic">oboes</span>. By the late <span>18th century</span>, music with instruments like <span class="italic">triangles</span>, 
                            <span class="italic">flutes</span>, <span class="italic">cymbals</span>, and <span class="italic">big drums</span>, known as 
                            <span>Janissary music</span>, became popular. During this time, the number of musicians in bands grew. In <span>1838</span>, 
                            an impressive band with <span>200 drummers</span> and <span>1,000 wind instrument</span> players performed for the <span>Russian emperor</span> in Berlin.
                        </p>				
					</div>
				</div>
			</div>
