...
if(isset($_GET['active'])){	
	...
	if($Status=='Yes'){
        ...
        $result1 = $mysqli->query("SELECT * FROM Trainer WHERE User_id=$id") or die($mysqli->error());
...
if(isset($_GET['delete'])){
    ...
    $mysqli->query("DELETE FROM Trainer WHERE User_id = $id") or die($mysqli->error());
...
if(isset($_POST['add_new'])){
    ...
    $dept = $_POST['dept'];
        ...
        $mysqli->query("INSERT INTO Users (Username, Password, Type, Status, Department) VALUES('$email', '$pass', 'trainer', 'Yes', '$dept')") or die($mysqli->error);
                    
        $result1 = $mysqli->query("SELECT * FROM Users WHERE Username = '$email' ") or die($mysqli->error());
		foreach($result1 as $row){
        	$User_id = $row['User_id'];
        	}
        $mysqli->query("INSERT INTO Trainer (First_Name, Middle_Name, Last_Name, Birthday, Email, Phone_No, User_id) VALUES(' ', ' ', ' ', ' ',  '$email', ' ', '$User_id' )") or die($mysqli->error);
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="list-of-trainers.php" class="dropdown-toggle no-arrow" style="background: #031E23; color: white;">
                                <span class="material-symbols-outlined micon" style="font-size: 30px;" data-color="#ffffff">person_play</span> 
											...
											<div class="form-group">
                                                <table class="data-table table nowrap">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = $mysqli->query("SELECT s.*, u.* FROM Trainer as s INNER JOIN Users as u ON s.User_id = u.User_id WHERE u.Type = 'trainer' ") or die($mysqli->error());
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a onClick="return confirm('CONFIRM REQUEST');" style="text-decoration: none" href="list-of-trainers?active=<?php echo $row['User_id']; ?>">
                                                            ...
                                                            <td>
                                                                <div class="table-actions">
                                                                    ...
                                                                    <a onClick="return confirm('CONFIRM REQUEST');" style="text-decoration: none" href="list-of-trainers.php?delete=<?php echo $row['User_id']; ?>" data-color="#e95959">
