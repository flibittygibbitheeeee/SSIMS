...
if(isset($_POST['update']) and isset ($_FILES['photo'])){	
    ...
    $mysqli->query("UPDATE `Trainer` SET file = '$file', type = '$file_type', size = '$file_size' WHERE User_id = $User_id") or die($mysqli->error);
}
...
if(isset($_POST['update_info'])){
	...
	$mysqli->query("UPDATE `Trainer` SET First_Name = '$fname', Middle_Name = '$mname', Last_Name = '$lname', Birthday = '$bday', Phone_No = '$phone' WHERE User_id = $User_id") or die($mysqli->error);
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="bday" onfocus="(this.type='date')" class="form-control" value="<?php echo $bday; ?>" />
											</div>
										</div>
									</div>
									<div class="row">
